...
@Generated(value = "omnigen", date = "2024-06-20T13:16:15.519Z")
...
public class Models {
  ...
  @Setter
  @SuperBuilder
  public static class AbstractAccountNotificationData<T extends AbstractAccountNotificationDataAttributes> extends AbstractNotificationRequestData {
    /**
  ...
  @Setter
  @SuperBuilder
  public static class AbstractAccountNotificationDataAttributes {
    /**
  ...
  @Setter
  @SuperBuilder
  public static class AbstractCancelNotificationData<T> extends AbstractNotificationRequestData {
    @JsonProperty(value = "attributes")
    private T attributes;
    /**
  ...
  @Setter
  @SuperBuilder
  public static class AbstractCreditNotificationData<T extends AbstractCreditNotificationDataAttributes> extends AbstractNotificationRequestData {
    /**
     * {@code 98.02}
     */
  ...
  @Setter
  @SuperBuilder
  public static class AbstractCreditNotificationDataAttributes implements IAdditionalProperties {
    @Singular
    @JsonAnySetter
  ...
  @Setter
  @SuperBuilder
  public static class AbstractDebitNotificationData<T> extends AbstractNotificationRequestData implements IAdditionalProperties {
    @Singular
    @JsonAnySetter
    private Map<String, Object> additionalProperties;
    /**
  ...
  @Setter
  @SuperBuilder
  public abstract static class AbstractPendingNotificationData implements IAbstractPendingNotificationData {
    /**
     * {@code 98.02}
     */
    @JsonProperty(value = "amount", required = true)
  ...
  @Setter
  @SuperBuilder
  public static class AccountDefaultNotification extends JsonRpcNotification<AccountDefaultNotification.Params> {
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends AbstractAccountNotificationData<Data.Attributes> {
        @Getter
        @Jacksonized
        @RequiredArgsConstructor
        @Setter
  ...
  @Setter
  @SuperBuilder
  public static class AccountDefaultNotificationResponse extends JsonRpcResponse<AccountDefaultNotificationResponse.Result> {
    @Getter
    @Jacksonized
    @RequiredArgsConstructor
    @Setter
    @SuperBuilder
    public static class Result extends ResponseResult<GeneralNotificationResponseData> {
  ...
  public static class AccountLedgerRequest extends JsonRpcRequest<AccountLedgerRequest.Params> {
    ...
    public static class Params extends JsonRpcRequestParams<Params.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends AbstractRequestData {
        /**
         * The ISO 4217 code of the currency. See <a href="https://eu.developers.trustly.com/doc/reference/handling-currencies">documentation</a>
         * <h5>Examples</h5>
         * <ul>
  ...
  @Setter
  @SuperBuilder
  public static class Any implements IAdditionalProperties {
    @Singular
    @JsonAnySetter
    private Map<String, Object> additionalProperties;
    public void addAdditionalProperty(String key, Object value) {
  ...
  public static class CancelChargeResponse extends JsonRpcResponse<CancelChargeResponse.Result> {
    ...
    public static class Result extends ResponseResult<Result.Data> {
      ...
      public static class Data {
        ...
        @JsonCreator
        public Data(Object raw) {
          this._raw = raw;
        }

        public ResponseDataWithReject getResponseDataWithReject(Function<Object, ResponseDataWithReject> transformer) {
          if (this._responseDataWithReject != null) {
            return this._responseDataWithReject;
          }
          return this._responseDataWithReject = transformer.apply(this._raw);
        }

        public ResponseDataWithResult getResponseDataWithResult(Function<Object, ResponseDataWithResult> transformer) {
          if (this._responseDataWithResult != null) {
            return this._responseDataWithResult;
          }
          return this._responseDataWithResult = transformer.apply(this._raw);
        }
  ...
  @Setter
  @SuperBuilder
  public static class CancelDefaultNotification extends JsonRpcNotification<CancelDefaultNotification.Params> {
    public CancelDefaultNotification() {
      super("cancel");
    }
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends AbstractCancelNotificationData<Any> {
        /**
         * The time of the transaction and the GMT offset (+01 means GMT + 1 hours).
         * <h5>Examples</h5>
         * <ul>
  ...
  @Setter
  @SuperBuilder
  public static class CancelDefaultNotificationResponse extends JsonRpcResponse<CancelDefaultNotificationResponse.Result> {
    @Getter
    @Jacksonized
    @RequiredArgsConstructor
    @Setter
  ...
  public static class CancelDirectCreditNotification extends JsonRpcNotification<CancelDirectCreditNotification.Params> {
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      public static class Data extends AbstractCancelNotificationData<Data.Attributes> {
        ...
        @Setter
        @SuperBuilder
        public static class Attributes implements IAdditionalProperties {
          @Singular
          @JsonAnySetter
          private Map<String, Object> additionalProperties;
          /**
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      public static class Data extends AbstractCancelNotificationData<Data.Attributes> {
        ...
        public static class Attributes implements IAdditionalProperties {
          ...
          private String details;
          @JsonProperty(value = "reason")
          private DirectDebitDebitNotificationReason reason;
          public void addAdditionalProperty(String key, Object value) {
            this.additionalProperties.put(key, value);
          }
  ...
  public static class CancelMandateNotification extends JsonRpcNotification<CancelMandateNotification.Params> {
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends AbstractCancelNotificationData<Data.MandateCancelNotificationDataAttributes> {
        @Getter
        @Jacksonized
        @Setter
        @SuperBuilder
        public static class MandateCancelNotificationDataAttributes {
          @JsonValue
          private final Object _raw;
          private AlreadyExistsMandateCancelNotificationDataAttributes _alreadyExistsMandateCancelNotificationDataAttributes;
          private OtherMandateCancelNotificationDataAttributes _otherMandateCancelNotificationDataAttributes;
          @JsonCreator
          public MandateCancelNotificationDataAttributes(Object raw) {
            this._raw = raw;
          }

          public AlreadyExistsMandateCancelNotificationDataAttributes getAlreadyExistsMandateCancelNotificationDataAttributes(Function<Object, AlreadyExistsMandateCancelNotificationDataAttributes> transformer) {
            if (this._alreadyExistsMandateCancelNotificationDataAttributes != null) {
              return this._alreadyExistsMandateCancelNotificationDataAttributes;
            }
            return this._alreadyExistsMandateCancelNotificationDataAttributes = transformer.apply(this._raw);
          }

          public OtherMandateCancelNotificationDataAttributes getOtherMandateCancelNotificationDataAttributes(Function<Object, OtherMandateCancelNotificationDataAttributes> transformer) {
            if (this._otherMandateCancelNotificationDataAttributes != null) {
              return this._otherMandateCancelNotificationDataAttributes;
            }
            return this._otherMandateCancelNotificationDataAttributes = transformer.apply(this._raw);
          }
          ...
          @Setter
          @SuperBuilder
          public static class AlreadyExistsMandateCancelNotificationDataAttributes {
            /**
             * The globally unique AccountID the account was assigned in our system. The AccountID of a returning customer. Allows for a quicker payment experience in some markets, see Trustly Express.
             * <h5>Examples</h5>
             * <ul>
            ...
            /**
             * If the mandate already exist
             */
            @JsonProperty(value = "reason")
            private MandateAlreadyExistsReason reason;
            /**
             * If the mandate already exist
             */
            public enum MandateAlreadyExistsReason {
              MANDATE_ALREADY_EXISTS("MANDATE_ALREADY_EXISTS");
              @JsonValue
              private final String value;
              MandateAlreadyExistsReason(String value) {
                this.value = value;
              }
            }
          }
          ...
          @Setter
          @SuperBuilder
          public static class OtherMandateCancelNotificationDataAttributes {
            /**
             * Description of reason. If Direct Debit Mandate, then  this applies when reason is <code>FAILED: BACS ADDACS_1(INSTRUCTION CANCELLED BY PAYER)</code>. See https://eu.developers.trustly.com/doc/reference/mdd#description-of-details-eg-failure-details
             */
            @JsonProperty(value = "details")
            private String details;
            @JsonProperty(value = "reason")
            private OtherMandateCancelNotificationReason reason;
            public enum OtherMandateCancelNotificationReason {
              /**
               * Either when the consumer cancels in the journey or if you call cancel mandate method.
               */
              CANCELLED("CANCELLED"),
              /**
               * If the underlayig scheme reports failure or cancelation of the mandate
               */
              FAILED("FAILED"),
              /**
              ...
              @JsonValue
              private final String value;
              OtherMandateCancelNotificationReason(String value) {
                this.value = value;
              }
            }
          }
  ...
  @Setter
  @SuperBuilder
  public static class CreditDefaultNotification extends JsonRpcNotification<CreditDefaultNotification.Params> {
    public CreditDefaultNotification() {
      super("credit");
    }
  ...
  @Setter
  @SuperBuilder
  public static class CreditDefaultNotificationResponse extends JsonRpcResponse<CreditDefaultNotificationResponse.Result> {
    @Getter
    @Jacksonized
    @RequiredArgsConstructor
    @Setter
  ...
  @Setter
  @SuperBuilder
  public static class DebitDefaultNotification extends JsonRpcNotification<DebitDefaultNotification.Params> {
    public DebitDefaultNotification() {
      super("debit");
    }
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends AbstractDebitNotificationData<Any> {
  ...
  @Setter
  @SuperBuilder
  public static class DebitDefaultNotificationResponse extends JsonRpcResponse<DebitDefaultNotificationResponse.Result> {
    @Getter
    @Jacksonized
    @RequiredArgsConstructor
    @Setter
  ...
  public static class DepositRequest extends JsonRpcRequest<DepositRequest.Params> {
    ...
    public static class Params extends JsonRpcRequestParams<Params.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends AbstractRequestData implements IAdditionalProperties {
        @Singular
        @JsonAnySetter
        private Map<String, Object> additionalProperties;
        @JsonProperty(value = "Attributes", required = true)
  ...
  public static class DirectCreditRequest extends JsonRpcRequest<DirectCreditRequest.Params> {
    ...
    public static class Params extends JsonRpcRequestParams<Params.Data> {
      ...
      public static class Data extends AbstractRequestData {
        ...
        @JsonInclude
        @NotNull
        private DirectDebitRequestDataAttributes attributes;
        /**
         * The branch identifier
         * <h5>Examples</h5>
         * <ul>
  ...
  @Setter
  @SuperBuilder
  public static class DirectDebitRequestDataAttributes implements IAdditionalProperties {
    @Singular
    @JsonAnySetter
    private Map<String, Object> additionalProperties;
  ...
  @Setter
  @SuperBuilder
  public static class GeneralNotificationResponseData extends NotificationResponseDataBase<GeneralNotificationResponseData.Status> implements IAdditionalProperties {
    @Singular
    @JsonAnySetter
    private Map<String, Object> additionalProperties;
    public void addAdditionalProperty(String key, Object value) {
  ...
  public static class KYCNotification extends JsonRpcNotification<KYCNotification.Params> {
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      public static class Data {
        ...
        public KYCAbortNotificationData getKycAbortNotificationData(Function<Object, KYCAbortNotificationData> transformer) {
          if (this._kycAbortNotificationData != null) {
            return this._kycAbortNotificationData;
          }
          return this._kycAbortNotificationData = transformer.apply(this._raw);
        }

        public KYCDefaultNotificationData getKycDefaultNotificationData(Function<Object, KYCDefaultNotificationData> transformer) {
          if (this._kycDefaultNotificationData != null) {
            return this._kycDefaultNotificationData;
          }
          return this._kycDefaultNotificationData = transformer.apply(this._raw);
        }
  ...
  @Setter
  @SuperBuilder
  public static class KYCNotificationDataAttributes {
    /**
     * The city of the recipient address.
     */
  ...
  public static class KYCNotificationResponse extends JsonRpcResponse<KYCNotificationResponse.Result> {
    ...
    public static class Result extends ResponseResult<Result.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends NotificationResponseDataBase<Data.KycNotificationResponseStatus> {
        /**
         * <h5>Examples</h5>
         * <ul>
         *   <li>BGN: 100.00</li>
        ...
        public enum KycNotificationResponseStatus {
          OK("OK"),
          FINISH("FINISH"),
          CONTINUE("CONTINUE");
          @JsonValue
          private final String value;
          KycNotificationResponseStatus(String value) {
            this.value = value;
          }
        }
      }
  ...
  @Setter
  @SuperBuilder
  public static class PendingDefaultNotification extends JsonRpcNotification<PendingDefaultNotification.Params> {
    public PendingDefaultNotification() {
      super("pending");
    }
    ...
    public static class Params extends JsonRpcNotificationParams<Params.Data> {
      ...
      @Setter
      @SuperBuilder
      public static class Data extends AbstractNotificationRequestData implements IAbstractPendingNotificationData {
        /**
         * {@code 98.02}
         */
        @JsonProperty(value = "amount", required = true)
  ...
  @Setter
  @SuperBuilder
  public static class PendingDefaultNotificationResponse extends JsonRpcResponse<PendingDefaultNotificationResponse.Result> {
    @Getter
    @Jacksonized
    @RequiredArgsConstructor
    @Setter
  ...
  public enum DirectDebitDebitNotificationReason {
    /**
     * The mandate is invalid for some reason.
     */
    ERROR_MANDATE_INVALID("ERROR_MANDATE_INVALID"),
    ...
    @JsonValue
    private final String value;
    DirectDebitDebitNotificationReason(String value) {
      this.value = value;
    }
  }
  ...
  public interface IAbstractPendingNotificationData {
    double getAmount();
    Any getAttributes();
    String getCurrency();
    String getMessageID();
